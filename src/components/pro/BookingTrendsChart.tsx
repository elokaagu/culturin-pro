        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex bg-gray-100 rounded-md p-1">
            <Button 
              variant="ghost" 
              size="sm" 
              className={`h-6 text-xs px-2 rounded-sm ${selectedTimeframe === '7days' ? 'bg-white shadow-sm' : ''}`}
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className={`h-6 text-xs px-2 rounded-sm ${selectedTimeframe === '30days' ? 'bg-white shadow-sm' : ''}`}
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className={`h-6 text-xs px-2 rounded-sm ${selectedTimeframe === '90days' ? 'bg-white shadow-sm' : ''}`}
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-gray-50 p-3 rounded-lg flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Due to Spring Wellness Retreat success</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Upselling strategy is working well</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg flex gap-3">
            ...
            <div>
              <p className="font-medium text-sm">Conversion rate steady at 3.2%</p>
              <p className="text-xs text-gray-600">Consider A/B testing your landing page</p>
            </div>
          </div>
        </div>
      </CardContent>
