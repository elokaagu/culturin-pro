    ...
    <div className="space-y-8">
      ...
      <Alert className="bg-blue-50 border-blue-100">
        ...
        <AlertDescription className="text-blue-800">
          Keep your cultural business secure by regularly updating your password
          and enabling two-factor authentication. These security measures
          protect your customer data and booking information.
        </AlertDescription>
      </Alert>
    </div>
  );
