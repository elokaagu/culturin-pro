        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Culturin Pro gives you everything you need to grow bookings,
              delight guests, and run your business like a pro.
            </p>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-700">
                  Your own branded guest app – Give travelers a premium booking
              ...
              <div className="flex items-start gap-2">
                <CheckCircle className="h-6 w-6 text-green-600 mt-0.5 flex-shrink-0" />
                <p className="text-gray-700">
                  Revenue-boosting booking engine – Optimized to convert and
                  upsell on autopilot
                </p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="h-6 w-6 text-green-600 mt-0.5 flex-shrink-0" />
                <p className="text-gray-700">
                  AI insights that unlock your audience – Know what works before
                  your competitors do
                </p>
              </div>
              <div className="flex items-start gap-2">
