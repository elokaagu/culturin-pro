            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-blue-600 flex items-center mt-1">
                    <TrendingUp className="h-3 w-3 mr-1" /> +2.5% from previous
                    period
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-blue-600 flex items-center mt-1">
                    <TrendingUp className="h-3 w-3 mr-1" /> +$4.20 from previous
                    period
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-blue-600 flex items-center mt-1">
                    <TrendingUp className="h-3 w-3 mr-1" /> +8.3% from previous
                    month
                  </p>
                    ...
                    {[
                      ...
                      <div key={index} className="border rounded-lg p-4">
                        ...
                        <div className="mt-2">
                          <Badge
                            variant={
                              pricing.status === "Underpriced"
                                ? "destructive"
                                : "default"
                            }
                            className={
                              pricing.status === "Optimal" ? "bg-blue-500" : ""
                            }
                          >
                            {pricing.status}
                          </Badge>
          ...
          <TabsContent value="insights" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track how visitors convert through each stage
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your top-performing cultural experiences
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Identify where customers abandon the booking process
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    {
                      stage: "Date Selection",
                      percentage: 28,
                      reason: "Limited availability on popular dates",
                    },
                    {
                      stage: "Payment Page",
                      percentage: 23,
                      reason: "Limited payment methods",
                    },
                    {
                      stage: "Guest Info Form",
                      percentage: 15,
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Manage your guides, storytellers, drivers and partners
                  </CardDescription>
                </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      {
                        message:
                          "Carlos Silva (Transport) requested schedule change for Aug 15",
                        time: "2 hours ago",
                      },
                      {
                        message:
                          "Sophie Chen (Culinary) returning from leave on Aug 20",
                        time: "Yesterday",
                      },
                      {
                        message: "Performance review due for Maria Rodriguez",
                        time: "3 days ago",
                      },
