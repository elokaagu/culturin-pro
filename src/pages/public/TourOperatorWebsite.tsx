    ...
    switch (theme.toLowerCase()) {
      ...
      default:
        return {
          ...
          headerTextClass: "text-white",
          buttonClass: `bg-[${operatorData?.primaryColor || '#9b87f5'}] hover:bg-opacity-90`,
        ...
        <div className="max-w-5xl mx-auto">
          <section className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">{operatorData?.description}</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className={cn("p-8 rounded-xl transition-all hover:shadow-xl", themeStyles.cardClass)}>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-medium ml-3">Local Expert Guides</h3>
                </div>
              ...
              <div className={cn("p-8 rounded-xl transition-all hover:shadow-xl", themeStyles.cardClass)}>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-medium ml-3">Small Group Sizes</h3>
                </div>
              ...
              <div className={cn("p-8 rounded-xl transition-all hover:shadow-xl", themeStyles.cardClass)}>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-medium ml-3">Authentic Experiences</h3>
                </div>
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">Choose from our carefully crafted tours and experiences</p>
            </div>
            
            <div className="space-y-12">
              {operatorData?.tours.map((tour: Tour) => (
                <Card key={tour.id} className={cn("overflow-hidden border-0 transition-all hover:shadow-xl", themeStyles.cardClass)}>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
                    <div className="h-72 md:h-full bg-cover bg-center rounded-t-lg md:rounded-l-lg md:rounded-tr-none" style={{ backgroundImage: `url(${tour.image})` }}></div>
                    <div className="col-span-2 p-8">
                      <h3 className="text-2xl font-semibold mb-3">{tour.name}</h3>
                      ...
                      <div className="flex items-center text-sm text-gray-500 mb-5 flex-wrap gap-4">
                        ...
                        <div className="flex items-center">
                          <Star className="h-4 w-4 mr-1" style={{color: primaryColor}} />
                      ...
                      <ul className="mb-7 space-y-2">
                        {tour.highlights.map((highlight: string, idx: number) => (
                          <li key={idx} className="flex items-start">
                            <div className="flex-shrink-0 rounded-full p-0.5 mt-1" style={{backgroundColor: `${primaryColor}20`}}>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-2xl font-bold">€{tour.price} <span className="text-sm font-normal text-gray-500">per person</span></div>
                        <Link 
                          to={`/product/booking-preview/${tour.id}`}
                        >
                          <Button 
          ...
          <section className="mb-12">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">Get in touch with our team to plan your perfect experience</p>
            </div>
            
            <div className={cn("rounded-xl overflow-hidden", themeStyles.cardClass)}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="flex items-center">
                      <svg className="h-5 w-5 mr-3" style={{color: primaryColor}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="flex space-x-4 mt-8">
                    <a href={operatorData?.socialMedia.facebook} className="text-gray-600 hover:text-blue-600 transition-colors">
                      <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                      </svg>
                    </a>
                    <a href={operatorData?.socialMedia.instagram} className="text-gray-600 hover:text-pink-600 transition-colors">
                      <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <a href={operatorData?.socialMedia.twitter} className="text-gray-600 hover:text-blue-400 transition-colors">
                      <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <div className="flex space-x-4">
                  <a href={operatorData?.socialMedia.facebook} className="text-gray-300 hover:text-white transition-colors">
                    <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                    </svg>
                  </a>
                  <a href={operatorData?.socialMedia.instagram} className="text-gray-300 hover:text-white transition-colors">
                    <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                    </svg>
                  </a>
                  <a href={operatorData?.socialMedia.twitter} className="text-gray-300 hover:text-white transition-colors">
                    <svg className="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                    </svg>
                  </a>
            ...
            <div className="border-t border-gray-800 pt-8 mt-8 text-sm text-gray-400">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <p className="mt-2 md:mt-0">Powered by <a href="/culturin-pro" className="text-white hover:text-opacity-80 font-medium">Culturin Pro</a></p>
              </div>
            </div>
          </div>
        </div>
