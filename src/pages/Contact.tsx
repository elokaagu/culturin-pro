  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 md:pt-32">
        ...
        <section ref={ref} id="contact-form" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className={`grid md:grid-cols-2 gap-12 lg:gap-16 transition-opacity duration-500 ${inView ? 'opacity-100' : 'opacity-0'}`}>
              {/* Contact Information */}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">See our <a href="/faqs" className="text-blue-600 hover:underline">FAQs</a> for quick answers to common questions.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="bg-gray-50 py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-7xl">
            <h2 className="text-3xl font-bold text-center mb-16">Additional Resources</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Card className="bg-white border-none shadow-md hover:shadow-lg transition-all">
                <CardContent className="p-8 flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 mb-6">Explore our detailed guides and tutorials</p>
                  <Button 
                    variant="outline" 
