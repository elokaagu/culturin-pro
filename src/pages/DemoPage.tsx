...
const DemoPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect to Culturin Pro page after form submission
    setTimeout(() => {
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  See how our tour operator software can transform your cultural experience business with a customized demo tailored to your specific needs.
                </p>
                <Card className="bg-blue-50 border-blue-100 p-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <p className="text-sm text-gray-700">
                      <span className="font-medium">Quick response time:</span> Our team typically responds within 24 hours to schedule your demo.
                    </p>
                  </div>
                </Card>
              </div>
              <div className="lg:w-1/2 w-full">
                <Card className="p-6 md:p-8 shadow-md border-gray-200">
                  <h2 className="text-2xl font-bold mb-6">Request your free demo</h2>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                      <label className="block text-sm font-medium mb-1" htmlFor="experienceType">
                      ...
                      >
                        ...
                        <option value="history">Historical & Heritage Tours</option>
                        <option value="art">Art & Museum Tours</option>
                        <option value="music">Music & Performance Experiences</option>
                        <option value="nature">Nature & Outdoor Cultural Experiences</option>
                        <option value="workshop">Workshops & Classes</option>
                        <option value="festival">Festival & Event Experiences</option>
        ...
        <section className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Why choose Culturin Pro?</h2>
              <p className="text-lg text-gray-600">
                Join thousands of cultural experience creators who are growing their businesses with our specialized platform.
              </p>
            </div>
