...
const AnalyticsScanPage = () => {
  ...
  useEffect(() => {
    ...
    if (tourParam) {
      setTourName(tourParam);
      // Auto-start scan if tour name is provided
      setTimeout(() => {
        handleScan();
      }, 500);
    }
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">
              Analyze Your Tour Performance
            </h1>
            <p className="text-lg text-gray-600">
              Diagnose booking drop-offs and discover optimization opportunities
              for your cultural experiences.
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  We'll analyze your booking flow and identify areas for
                  improvement.
                </p>
              </div>
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium">
                        Booking form abandonment (64%)
                      </p>
                      <p className="text-sm text-gray-600">
                        Users leave during the payment step
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
