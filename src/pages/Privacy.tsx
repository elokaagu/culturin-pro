            ...
            >
              <div className="bg-white p-6 md:p-10 rounded-lg shadow-soft mb-10">
                ...
                <p className="text-gray-600 mb-6">
                  At Culturin, we value your privacy and are committed to
                  protecting your personal data. This Privacy Policy explains
                  how we collect, use, and safeguard your information when you
                  use our platform to discover and book cultural experiences or
                  offer your services as a host.
                </p>
                <p className="text-gray-600">
                  We designed Culturin with your privacy in mind and ensure that
                  all data processing complies with applicable data protection
              ...
              <div className="space-y-12 text-gray-700">
                  ...
                  <div className="space-y-4">
                    <div className="pl-5 border-l-2 border-culturin-indigo">
                      ...
                      <p className="mt-2">
                        ...
                        address, phone number, and payment information. For
                        hosts, we may collect additional verification
                        information.
                      </p>
                    </div>
                    ...
                    <div className="pl-5 border-l-2 border-culturin-indigo">
                      ...
                      <p className="mt-2">
                        ...
                        platform, including browsing history, searches,
                        bookings, and communications with hosts or travelers.
                      </p>
                    </div>
                    ...
                    <div className="pl-5 border-l-2 border-culturin-indigo">
                      ...
                      <p className="mt-2">
                        ...
                        IP address, browser type, operating system, and mobile
                        device identifiers.
                      </p>
                    </div>
                  </div>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      To facilitate bookings and payments between travelers and
                      hosts
                    </li>
                    <li>
                    ...
                    <li>
                      To personalize your experience and recommend relevant
                      experiences
                    </li>
                    <li>
                      To ensure the security and proper functioning of our
                      platform
                    </li>
                    <li>
                      To communicate important updates and marketing information
                      (with your consent)
                    </li>
                    <li>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <p className="mt-1 text-sm">
                        We share necessary contact and booking information
                        between travelers and hosts to facilitate experiences.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <p className="mt-1 text-sm">
                        We work with trusted third parties to provide services
                        such as payment processing, customer support, and data
                        analysis.
                      </p>
                    </div>
                ...
                <section>
                  ...
                  <p>
                    ...
                    strive to protect your personal information, no method of
                ...
                <section>
                  ...
                  <p>
                    ...
                    countries outside of your country of residence, where data
                    protection laws may differ. We ensure appropriate safeguards
                ...
                <section>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p className="mb-3">
                      <a
                        href="mailto:privacy@culturin.com"
                        className="text-culturin-indigo hover:underline"
                      >
                        privacy@culturin.com
                      </a>
                    </p>

                    <p className="font-semibold mb-1">Address:</p>
                    <p className="mb-3">
                      Culturin Privacy Team
                      <br />
                      123 Cultural Street
                      <br />
