      ...
      <div className="pt-16"> {/* Reduced from pt-20 to pt-16 to match header height */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className={`space-y-6 ${animateItems ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} transition-all duration-700`}>
                <h1 className="text-4xl md:text-5xl font-medium text-gray-900 leading-tight">
                  Tour Operator Platform for <span className="text-[#9b87f5]">Cultural Experiences</span>
                </h1>
                
                <p className="text-lg text-gray-600 leading-relaxed">
                  A comprehensive platform that helps you manage bookings, track performance, and deliver exceptional cultural experiences without complex tools.
                </p>
              ...
              <div className={`${animateItems ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} transition-all duration-700 delay-300`}>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-medium mb-4">Manage Your Cultural Tours</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Our platform provides the essential tools you need to manage bookings, analyze performance, and support your customers effectively.
              </p>
            </div>
        ...
        <section className="py-20 bg-[#f1f0fb]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-medium mb-6">Your Complete Dashboard</h2>
                <p className="text-lg text-gray-600 mb-8">
                  Access all the tools you need to manage your cultural experience business in one intuitive interface.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-medium mb-1">Booking Calendar</h3>
                      <p className="text-gray-600">
                        View and manage your schedule with an interactive calendar that shows all upcoming bookings.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-medium mb-1">Customer Database</h3>
                      <p className="text-gray-600">
                        Keep track of customer information and preferences to provide personalized experiences.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Choose the plan that fits your business needs with no hidden fees or commissions.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <Card className="border hover:shadow-lg transition-all duration-300">
                <CardHeader className="pb-2 text-center">
                  ...
                  <p className="text-3xl font-bold mt-2">£49<span className="text-base font-normal text-gray-500">/month</span></p>
                </CardHeader>
                <CardContent>
                  ...
                  <Button className="w-full bg-[#9b87f5] hover:bg-[#7E69AB]" onClick={() => navigate('/sign-in')}>
                    Get Started
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-[#9b87f5] shadow-lg relative">
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#9b87f5] text-white px-4 py-1 rounded-full text-sm font-medium">Popular</div>
                <CardHeader className="pb-2 text-center">
                  <CardTitle className="text-xl">Professional</CardTitle>
                  <p className="text-3xl font-bold mt-2">£99<span className="text-base font-normal text-gray-500">/month</span></p>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
              ...
              <Card className="border hover:shadow-lg transition-all duration-300">
                <CardHeader className="pb-2 text-center">
                  ...
                  <p className="text-3xl font-bold mt-2">£199<span className="text-base font-normal text-gray-500">/month</span></p>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
        ...
        <section className="py-20 bg-gradient-to-br from-[#9b87f5] to-[#7E69AB] text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-medium mb-6">Ready to transform your cultural tour business?</h2>
              <p className="text-xl mb-10 text-white/90">
                Join tour operators already growing their business with Culturin Pro
              </p>
