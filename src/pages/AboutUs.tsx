      ...
      >
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Culturin was born from a simple idea: that the most meaningful travel experiences don't come from tour buses or bucket lists — they come from people.
            </p>
            <p 
            ...
            >
              We're building a home for cultural hosts, local guides, and creative storytellers who want to share their world on their terms — and for travelers who want to experience it all with depth, purpose, and joy.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className={`text-3xl md:text-4xl font-bold mb-12 text-center flex items-center justify-center gap-3 transition-all duration-700 ${
              whatWeDoInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className={`transition-all duration-700 ${
                ...
                <h3 className="text-2xl font-bold mb-6 text-culturin-accent">We help cultural hosts:</h3>
                <ul className="space-y-4 text-gray-700">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-green-600 font-bold">✓</span>
                    <span>Grow their communities and income — with full creative freedom</span>
                  </li>
                </ul>
              </div>
              ...
              <div className={`transition-all duration-700 ${
                ...
                <h3 className="text-2xl font-bold mb-6 text-culturin-accent">We help travelers:</h3>
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    <span className="text-green-600 font-bold">✓</span>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className={`text-3xl md:text-4xl font-bold flex items-center justify-center gap-3 transition-all duration-700 ${
                whyItMattersInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
              ...
              <div className="aspect-video relative">
                ...
                <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-center">
                  <p className="text-white text-lg md:text-xl max-w-2xl leading-relaxed">
                    <span className="font-bold block mb-4 text-xl md:text-2xl">Mainstream travel platforms weren't built for cultural hosts.</span>
                    They flatten stories. They reward algorithms. They often miss the soul.
                    <span className="block mt-4">
                      We want to change that — by building a more equitable, creator-first platform that respects culture, empowers local economies, and builds real connection between people.
                    </span>
                  </p>
                </div>
              </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className={`text-3xl md:text-4xl font-bold mb-6 flex items-center justify-center gap-3 transition-all duration-700 ${
              ...
              <div className={`transition-all duration-700 ${
                ...
                <p className="text-lg md:text-xl text-gray-700">
                  A world where cultural exchange is easy, ethical, and empowering.
                </p>
                <p className="text-lg md:text-xl text-gray-700 mt-2">
                  Where local guides are celebrated as teachers, creatives, and entrepreneurs.
                </p>
                <p className="text-lg md:text-xl text-gray-700 mt-2">
                  Where travel doesn't just look good on Instagram — it feels good in your spirit.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className={`mt-4 text-lg text-gray-600 transition-all duration-700 ${
                teamInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`} style={{ transitionDelay: '200ms' }}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                <Card key={member.name} className={`overflow-hidden transition-all duration-700 hover:shadow-lg ${
                  teamInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className={`text-3xl md:text-4xl font-bold mb-6 transition-all duration-700 ${
              joinUsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              Join Us
            </h2>
            <p className={`text-lg md:text-xl mb-10 transition-all duration-700 ${
              joinUsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`} style={{ transitionDelay: '200ms' }}>
