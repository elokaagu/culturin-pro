  ...
  useEffect(() => {
    ...
    if (currentAnnouncement) {
      ...
      const related = announcements
        .filter(a => a.category === currentAnnouncement.category && a.id !== id)
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <Card className="p-6 bg-blue-50 border-blue-100 mb-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-blue-900">When does this take effect?</h3>
            </div>
            <p>This update is available now for all customers. Check out the new features by logging into your dashboard.</p>
          </Card>
                ...
                {relatedItems.map((item) => (
                  <Card key={item.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <Link to={`/whats-new/${item.id}`} className="text-blue-600 hover:underline text-sm">
                        Read more
                      </Link>
                    </div>
                  </Card>
