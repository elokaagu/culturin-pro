            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Understand your business performance, identify trends, and make informed decisions with our powerful analytics dashboard.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Our analytics dashboard gives you the insights you need to optimize your experiences and grow your business.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Track key performance indicators like bookings, revenue, and customer satisfaction."
                },
                {
                  icon: <Users className="h-10 w-10 text-blue-600" />,
                  title: "Audience Insights",
                  description: "Understand who your customers are, where they come from, and what they're interested in."
                },
                {
                  icon: <RefreshCcw className="h-10 w-10 text-blue-600" />,
                  title: "Real-time Updates",
                  description: "Get up-to-the-minute data on your business performance and customer activity."
                }
              ].map((feature, index) => (
                <div 
                  key={index}
