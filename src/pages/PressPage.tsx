    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-10">
                Latest news, press releases, and media resources from Culturin. For press inquiries, please contact <a href="mailto:press@culturin.com" className="text-blue-600 hover:underline">press@culturin.com</a>.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card className="p-6">
                  ...
                  <p className="text-gray-600 mb-6">
                    Download our official logos, product images, and brand guidelines.
                  </p>
                  <Button>
                    Download Media Kit
                  </Button>
                ...
                <Card className="p-6">
                  ...
                  <p className="text-gray-600 mb-6">
                    Key statistics and information about Culturin for media reference.
                  </p>
                  <Button>
                    View Company Fact Sheet
                  </Button>
                </Card>
              </div>
            </div>
        ...
        <section className="bg-white py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold mb-10">Press Releases</h2>
              ...
              <div className="space-y-8">
                {pressReleases.map((release, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl md:text-2xl font-bold mb-2">{release.title}</h3>
        ...
        <section className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold mb-10">Culturin in the News</h2>
                ...
                {pressFeatures.map((feature, index) => (
                  ...
                  >
                    <div className="p-6 border border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-sm transition-all">
                      <div className="text-sm font-medium text-blue-600 mb-2">{feature.publication}</div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-600 mb-8">
                For press inquiries, interview requests, or other media opportunities, please contact our press team.
              </p>
              <Button 
