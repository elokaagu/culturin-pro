      ...
      <main className="flex-1 pt-24">
        ...
        <section className="relative bg-blue-600 text-white py-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image src="https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=2070&auto=format&fit=crop" alt="Frequently Asked Questions" className="w-full h-full object-cover opacity-30" fill />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl opacity-90 mb-8">
                Find answers to common questions about Culturin, experiences, and more.
              </p>
