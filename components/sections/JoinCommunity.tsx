          ...
          >
            <div className="max-w-xl mx-auto lg:mx-0">
              <h2 className="font-playfair text-3xl md:text-4xl lg:text-5xl mb-4 leading-tight tracking-tight text-culturin-charcoal">
                <TranslatableText text="This is just the beginning. Join the journey." />
              </h2>
              <p className="text-lg md:text-xl mb-8 leading-relaxed text-[#4A4A4A]">
                <TranslatableText text="Get early access to cultural experiences, stories, and discoveries." />
              </p>
                  ...
                  <form onSubmit={handleNewsletterSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={userType} onValueChange={setUserType}>
                        <SelectTrigger
                          id="userType"
                          className="bg-white border-[#DADADA] text-[#2B2B2B] h-14 rounded-xl px-5"
                        >
                          <SelectValue
                        ...
                        <SelectContent className="bg-white border-[#DADADA]">
                          ...
                          <SelectItem value="host" className="text-[#2B2B2B]">
                            Cultural Host
                          </SelectItem>
                          <SelectItem
                            value="explorer"
