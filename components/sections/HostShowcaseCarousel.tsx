...
const carouselItems = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1488921618671-463b781ac428?q=80&w=2000&auto=format&fit=crop",
  },
  {
    id: 2,
    ...
    image:
      "https://images.unsplash.com/photo-1566159199022-cb2a0fb958e5?q=80&w=2000&auto=format&fit=crop",
  },
  {
    id: 3,
    ...
    image:
      "https://images.unsplash.com/photo-1528702748617-c64d49f918af?q=80&w=2000&auto=format&fit=crop",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1543874869-82e11eb66a7c?q=80&w=2000&auto=format&fit=crop",
  },
  {
    id: 6,
    ...
    image:
      "https://images.unsplash.com/photo-1581878070537-c36ddf7e7a53?q=80&w=2000&auto=format&fit=crop",
  },
  {
    id: 7,
    ...
    image:
      "https://images.unsplash.com/photo-1528495612343-9ca9f4a4de28?q=80&w=2000&auto=format&fit=crop",
  },
];
    ...
    >
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2
            className={`text-3xl md:text-4xl lg:text-5xl font-semibold text-[#111111] mb-6 transition-all duration-700 ${
              animateItems
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
          >
            <TranslatableText text="Experience Hosts Growing With Culturin" />
          </h2>
          <p
            className={`text-base text-[#4A4A4A] transition-all duration-700 ${
              animateItems
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
          ...
          >
            <TranslatableText text="Join our community of cultural storytellers and grow your audience of authentic travelers." />
          </p>
        </div>
