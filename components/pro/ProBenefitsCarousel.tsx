...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Join our community of happy cultural hosts & travel entrepreneurs",
...
const ProBenefitsCarousel = () => {
  ...
  const testimonials = getFeaturedTestimonials().filter(
    (t) => t.type === "customer"
  );
    ...
    <div ref={ref} className="py-12">
      ...
      <div className="mb-12">
        <h3 className="text-xl font-semibold mb-6 text-center">
          Why Cultural Operators Choose Pro
        </h3>
                  ...
                  <div className="relative h-48">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                      <div className="p-4 text-white">
                        <Badge className="mb-2 bg-culturin-indigo text-white border-none">
                          Pro Member
                        </Badge>
